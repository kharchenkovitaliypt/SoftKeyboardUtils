...
//                        fullScreenModeListenerCancelable = setFullScreenModeChangeListener(view, new OnFullScreenModeChangedListener() {
//                            @Override
...
//        view.getViewTreeObserver().addOnGlobalLayoutListener(globalLayoutListener);
//
//        return new FullScreenModeCancelable(view, globalLayoutListener, fullScreenModeContext);
//    }
//
...
//
//        FullScreenModeCancelable(View view,
//                                 ViewTreeObserver.OnGlobalLayoutListener globalLayoutListener,
